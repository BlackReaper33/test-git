...
import { AddChannelAction } from '../../actions/types';
...
export default function ActionsModal(props: ActionsModalProps) {
  ...
  const handleCreateServer = async (serverName: string, userId: string) => {
    ...
    } catch (err) {  let errorMessage = "Failed to do something exceptional";
...
function handleSnackMessage(data: any, arg1: boolean) {
  throw new Error('Function not implemented.');
}

function dispatch(arg0: AddChannelAction) {
  throw new Error('Function not implemented.');
}

function showhandleCreateServer(): void {
  throw new Error('Function not implemented.');
}

function showhandleJoinServer(): void {
  throw new Error('Function not implemented.');
}

function setServerName(value: string): void {
  throw new Error('Function not implemented.');
}

function handleCreateServer(serverName: any, userId: any) {
  throw new Error('Function not implemented.');
}

function serverName(serverName: any, userId: any) {
  throw new Error('Function not implemented.');
}

function userId(serverName: any, userId: any) {
  throw new Error('Function not implemented.');
}
...
function serverId(serverId: any, userId: any) {
  throw new Error('Function not implemented.');
}

function setChannelName(value: string): void {
  throw new Error('Function not implemented.');
}

function channelName(channelName: any, activeServer: any) {
  throw new Error('Function not implemented.');
}

function activeServer(channelName: any, activeServer: any) {
  throw new Error('Function not implemented.');
}
